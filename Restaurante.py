...
def eliminar_plato():
    ...
    linea_borrar = int(input("Introduce el número del plato que deseas: \n"))
    fichero_borrado_plato = open(ruta_platos, 'r+', encoding='utf8')
    numlines = 0
    for linea in fichero_borrado_plato.readlines():
        numlines += 1
